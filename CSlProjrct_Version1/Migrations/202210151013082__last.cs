namespace CSlProjrct_Version1.Migrations
{
    ...
    public partial class _last : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        option3 = c.String(),
                        option4 = c.String(),
                        answerChoice = c.String(maxLength: 1),
                        StudentanswerChoice = c.String(maxLength: 1),
                        degree = c.Int(),
                    })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.exam_id, t.Student_id, t.question_id })
                .ForeignKey("dbo.Exams", t => t.exam_id, cascadeDelete: true)
